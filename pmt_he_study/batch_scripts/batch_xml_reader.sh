...
ls $root_dir/data/raw_xml_files/*/*.xml /unix/nemo3/PMT_He_Study_nemo3/data/raw_xml_files/*/*.xml > $root_dir/PMT-ShapeAnalysis/pmt_he_study/batch_files/$script_log_dir/filenames.ascii
