...
def average_afterpulse_rate(file_path, date, time):
  ...
  control_rate = (control_number/control_hist.GetEntries())
...
def graph(days, cr, cr_e, er, er_e, name, st_date, times):
  ...
  plt.ylabel("Average number of afterpulses per waveform ")
  ...
  plt.title("Average number of afterpulses over time")
